/**
 * This file contains the rune list.
 * Check the script "py/download_all_runes" to download all the runes from the Dofus servers.
 * Check the script "py/retrieve_runes_list" to generate the javascript rune list.
 */
...
var runes = [
    ...
    { label: "Rune Pa Puit", category: "Runes de type Pa", icon: "images/runes/Rune Pa Puit (6).png", weight: "6"},
    ...
    { label: "Rune Puit", category: "Runes de type simple", icon: "images/runes/Rune Puit (2).png", weight: "2"},
    ...
    { label: "Rune Ra Puit", category: "Runes de type Ra", icon: "images/runes/Rune Ra Puit (20).png", weight: "20"},
